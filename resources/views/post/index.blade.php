...
@section('content')
    ...
    <div class="w-full bg-gray-700">     
        <h1 class=" p-2 text-lg font-semibold text-white mx-auto">Post</h1>
        <div class=" p-2"><a href="post/create"><x-secondary-button>Create Post</x-secondary-button></a>
    </div>
    
    </div>
    <div class="w-full bg-stone-300 p-3 flex items-center justify-center">
    <div class=" columns-1 sm:grid-cols-4 sm:grid ">
    @foreach($posts as $post)
    <a href="post/{{$post->id}}">
    <div class="bg-blue-500  hover:bg-blue-700 hover:scale-105 w-40 h-60 m-3 rounded-md ">
